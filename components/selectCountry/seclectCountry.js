...
function SeclectCountry() {
  return (
    <select name="country" id="country" className={style.selectCountry}>
      ...
      <optgroup id="country-optgroup-Asia" label="Asia">
        ...
        <option value="YD" label=" Democratic Republic of Yemen">
